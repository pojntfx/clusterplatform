...
--request PUT \
--header "Content-Type: application/json" \
--data '{"distributorTags":["sol-earth-eu-de-bw-fds-bbronn-hirschkopfweg-8-pojtinger-felicitas-local"],"device":"enp0s25","domain":"sol-earth-eu-de-bw-fds-bbronn-hirschkopfweg-8-pojtinger-felicitas-local"}' \
